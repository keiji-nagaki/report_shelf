...
<body>
  <form action="todo_create.php" method="POST" enctype="multipart/form-data">
    <fieldset>
      ...
      <div>
        補器名: <input type="text" name="auxiliaries">
      </div>
      <div>
        補器番号: <input type="text" name="auxiliaries_number">
      </div>
      <div>
        補器名称: <input type="text" name="auxiliaries_name">
      </div>
      <div>
        修理年: <input type="text" name="year">年　※半角数字4桁で入力
      </div>
      <div>
        仕様書: <input type="file" name="specification" accept=".pdf">
      </div>
      <div>
